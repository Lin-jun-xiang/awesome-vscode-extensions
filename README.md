...
* This project will provide detailed instructions for each extension, hoping to help coders around the world code happily together: emoji_emoji_sunglasses:
...
* You can download the `.ps1` file that comes with this project, then follow step 3 below to exclude the extension . you don't want
...
* :pushpin: **Execute code line by line** and **Execute partial code** (really useful, better than debugging~:heart_eyes :)
